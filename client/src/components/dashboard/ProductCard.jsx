...
const ProductCard = ({ item, setShowpopUp, setId }) => {
  ...
  return (
    <div className="grid cursor-pointer grid-cols-5 gap-2 rounded-xl bg-white p-3 shadow-md">
      <div className="col-span-2 flex gap-3">
        ...
        <div className="flex w-[50%] flex-col items-start gap-2 ">
          ...
          <div className="flex items-center justify-end gap-1 py-2 sm:hidden">
            <AiOutlineEye
      ...
      <div className="">
        <h2>{item?.sold} nos</h2>
        <div className="hidden items-center justify-end gap-2 py-2 sm:flex">
          <AiOutlineEye
            onClick={() => navigate(`/product/${item._id}`)}
            size={"22px"}
            className="cursor-pointer hover:scale-110"
